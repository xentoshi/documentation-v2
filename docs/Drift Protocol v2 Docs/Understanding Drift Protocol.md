...
1.  Spot Trading - [What is Spot Margin Trading?](<../User Setup/What is Spot Margin Trading_.md>)&#x20;

2.  Perpetuals Trading - [What are Perpetual Futures?](<../User Setup/What are Perpetual Futures_.md>)&#x20;

3.  Borrow & Lend - [What is Borrow & Lend?](<../User Setup/What is Borrow _ Lend_.md>)&#x20;
...
_For a more technical breakdown, check out: _[Just-In-Time (JIT) Auctions](<../Drift Protocol v2 Docs/Just-In-Time _JIT_ Auctions.md#mFAd->)
...
_For a more technical breakdown, check out: _[Decentralised Orderbook FAQ](<../Drift Protocol v2 Docs/Decentralised Orderbook FAQ.md>).
...
Limit orders are placed by users on-chain. A network of Keeper Bots ([Keeper Bots](<../Guides/Keeper Bots.md>)) then sorts the on-chain limit orders into an off-chain orderbook and categorises limit orders from oldest to newest, and largest to smallest.&#x20;
